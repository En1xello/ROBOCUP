...
def right_wall_moving():
    while robot.step(timestep) != -1:
        ...
        right_wall = distance_sens[3].getValue() < 0.08
        front_wall_R = distance_sens[2].getValue() < 0.08
        right_corner = distance_sens[4].getValue() < 0.08
...
while robot.step(timestep) != -1:
    while distance_sens[0].getValue() == distance_sens[3].getValue():
